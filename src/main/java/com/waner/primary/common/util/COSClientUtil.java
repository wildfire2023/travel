...
public class COSClientUtil {
    // 这些变量信息自行到 腾讯云对象存储控制台 获取
    // 存储通名称			替换成自己的
    private static final String bucketName = Constants.COS_BUCKET_NAME + "-" + Constants.COS_APP_ID;
    // secretId 			替换成自己的
    private static final String secretId = Constants.COS_SECRET_ID;
    // secretKey		        替换成自己的
    private static final String secretKey = Constants.COS_SECRET_KEY;
     ...
     * @param url
     */
    public static void uploadImg2Cos(String url) throws Exception {
    ...
    public static String uploadFile2Cos(MultipartFile file) throws IOException {
    ...
    public static String uploadFile2Cos(InputStream instream, String fileName) {
        ...
        try {
            ...
            PutObjectResult putResult =
                    cosClient.putObject(bucketName, fileName, instream, objectMetadata);
